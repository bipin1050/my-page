                    ...
                    <div class="col-lg-4">
                        <div class="contact-info-card">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-10 ">
                                    <h6 class="d-inline">Phone : <br/> <span class="text-muted">+977 9863490911</span></h6>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-1 pt-1 mr-1">
                                ...
                                <div class="col-10">
                                    <h6 class="d-inline">Address :<br/> <span class="text-muted">Syangja, Nepal</span></h6>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-1 pt-1 mr-1">
                                ...
                                <div class="col-10">
                                    <h6 class="d-inline">Email :<br/> <span class="text-muted">bipin.khanal1050@gmail.com</span></h6>
                                </div>
                            </div>
